...
/****** USART Event(continuation) *****/

#define ARM_USART_EVENT_RX_IDLE                (1UL << 14)
#define ARM_USART_EVENT_RING_BUFFER_OVERFLOW   (1UL << 15)
#define ARM_USART_EVENT_RING_BUFFER_UNDERFLOW  (1UL << 16)
